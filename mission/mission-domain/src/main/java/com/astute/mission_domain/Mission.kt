...
//change Hero to Mission
//TODO: determine which of these variables can be extrapolated into different Mission types?

data class Mission(
    val id: Int,
    val localizedName: String,
    val primaryAttribute: MissionAttribute,
    val attackType: MissionAttackType,
    val roles: List<MissionRole>,
    val img: String,
    val icon: String,
