package com.astute.ui_missionlist
...
import ui_missionlist.ui.test.TAG_MISSION_NAME
import ui_missionlist.ui.test.TAG_MISSION_PRIMARY_ATTRIBUTE
    ...
    Surface(
        ...
        Row(
            ...
            Column(
                ...
                Text(
                    modifier = Modifier
                        .testTag(TAG_MISSION_PRIMARY_ATTRIBUTE)
                    ,
...
//                val proWR: Int = remember{round(mission.proWins.toDouble() / mission.proPick.toDouble() * 100).toInt()}
                val proWR: Int = round(mission.proWins.toDouble() / mission.proPick.toDouble() * 100).toInt()
                Text(
                    text = "${proWR}%",
